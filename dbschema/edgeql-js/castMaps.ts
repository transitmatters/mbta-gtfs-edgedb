...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$WheelchairTransferType ? _default.$WheelchairTransferType : 
  T extends _default.$WheelchairBoardingType ? _default.$WheelchairBoardingType : 
  T extends _default.$TransferType ? _default.$TransferType : 
  T extends _default.$ServiceExceptionType ? _default.$ServiceExceptionType : 
  T extends _default.$ScheduleTypicality ? _default.$ScheduleTypicality : 
  T extends _default.$ScheduleType ? _default.$ScheduleType : 
  T extends _default.$RouteType ? _default.$RouteType : 
  T extends _default.$RoutePatternTypicality ? _default.$RoutePatternTypicality : 
  T extends _default.$RouteFareClass ? _default.$RouteFareClass : 
  T extends _default.$PickupDropoffType ? _default.$PickupDropoffType : 
  T extends _default.$LocationType ? _default.$LocationType : 
  T extends _default.$ListedRouteType ? _default.$ListedRouteType : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _schema.$AccessKind ?
    ...
    never
  :
  A extends _default.$WheelchairTransferType ?
    B extends _default.$WheelchairTransferType ?
    B
    :
    never
  :
  A extends _default.$WheelchairBoardingType ?
    B extends _default.$WheelchairBoardingType ?
    B
    :
    never
  :
  A extends _default.$TransferType ?
    B extends _default.$TransferType ?
    B
    :
    never
  :
  A extends _default.$ServiceExceptionType ?
    B extends _default.$ServiceExceptionType ?
    B
    :
    never
  :
  A extends _default.$ScheduleTypicality ?
    B extends _default.$ScheduleTypicality ?
    B
    :
    never
  :
  A extends _default.$ScheduleType ?
    B extends _default.$ScheduleType ?
    B
    :
    never
  :
  A extends _default.$RouteType ?
    B extends _default.$RouteType ?
    B
    :
    never
  :
  A extends _default.$RoutePatternTypicality ?
    B extends _default.$RoutePatternTypicality ?
    B
    :
    never
  :
  A extends _default.$RouteFareClass ?
    B extends _default.$RouteFareClass ?
    B
    :
    never
  :
  A extends _default.$PickupDropoffType ?
    B extends _default.$PickupDropoffType ?
    B
    :
    never
  :
  A extends _default.$LocationType ?
    B extends _default.$LocationType ?
    B
    :
    never
  :
  A extends _default.$ListedRouteType ?
    B extends _default.$ListedRouteType ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::WheelchairTransferType") {
    if(b.__name__ === "default::WheelchairTransferType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::WheelchairBoardingType") {
    if(b.__name__ === "default::WheelchairBoardingType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::TransferType") {
    if(b.__name__ === "default::TransferType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::ServiceExceptionType") {
    if(b.__name__ === "default::ServiceExceptionType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::ScheduleTypicality") {
    if(b.__name__ === "default::ScheduleTypicality") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::ScheduleType") {
    if(b.__name__ === "default::ScheduleType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::RouteType") {
    if(b.__name__ === "default::RouteType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::RoutePatternTypicality") {
    if(b.__name__ === "default::RoutePatternTypicality") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::RouteFareClass") {
    if(b.__name__ === "default::RouteFareClass") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::PickupDropoffType") {
    if(b.__name__ === "default::PickupDropoffType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::LocationType") {
    if(b.__name__ === "default::LocationType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::ListedRouteType") {
    if(b.__name__ === "default::ListedRouteType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
