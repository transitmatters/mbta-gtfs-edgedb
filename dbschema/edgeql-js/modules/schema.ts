...
export type $ObjectTypeλShape = $.typeutil.flatten<$InheritingObjectλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $AnnotationSubjectλShape & Omit<$TypeλShape, "<target"> & $SourceλShape & {
  ...
  "<__type__[is CalendarDate]": $.LinkDesc<_default.$CalendarDate, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is GtfsArchive]": $.LinkDesc<_default.$GtfsArchive, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is BelongsToArchive]": $.LinkDesc<_default.$BelongsToArchive, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Line]": $.LinkDesc<_default.$Line, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Route]": $.LinkDesc<_default.$Route, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is RoutePattern]": $.LinkDesc<_default.$RoutePattern, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Service]": $.LinkDesc<_default.$Service, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Shape]": $.LinkDesc<_default.$Shape, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Stop]": $.LinkDesc<_default.$Stop, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is StopTime]": $.LinkDesc<_default.$StopTime, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Transfer]": $.LinkDesc<_default.$Transfer, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Trip]": $.LinkDesc<_default.$Trip, $.Cardinality.Many, {}, false, false,  false, false>;
